...
func TestBasic(t *testing.T) {
	...
	stream := streamprotocol.NewEncoder(ID, countOfVariables, samplingRate, samplesPerMessage)
	streamDecoder := streamprotocol.NewDecoder(ID, countOfVariables, samplingRate)
